  ...
  function (_Resolver) {
    ...
    _createClass(Router, [{
      ...
      value: function __fullyResolveChain(topOfTheChainContextBeforeRedirects) {
        ...
        .then(function (contextAfterRedirects) {
          ...
          return contextAfterRedirects.next().then(function (nextChildContext) {
            ...
            return nextChildContext && nextChildContext !== notFoundResult ? _this4.__fullyResolveChain(topOfTheChainContextAfterRedirects, nextChildContext) : _this4.__amendWithOnBeforeCallbacks(contextAfterRedirects);
          });
        });
      }
    }, {
      ...
      value: function __runOnBeforeCallbacks(newContext) {
        ...
        if (previousChain.length) {
          ...
          if (newContext.__skipAttach) {
            ...
            for (var _i = newChain.length - 1; _i >= 0; _i--) {
              if (previousChain[_i].path !== newChain[_i].path || newContext.search !== previousContext.search) {
            ...
            for (var _i2 = 0; _i2 < newChain.length; _i2++) {
              if (previousChain[_i2].path !== newChain[_i2].path || newContext.search !== previousContext.search) {
        ...
        for (var _i4 = newContext.__divergedChainIndex; !newContext.__skipAttach && _i4 < newChain.length; _i4++) {
          callbacks = this.__runOnBeforeEnterCallbacks(callbacks, newContext, {
            prevent: prevent,
            redirect: redirect
          }, newChain[_i4]);
